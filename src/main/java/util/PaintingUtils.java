...
public class PaintingUtils {
    ...
    public static void getPaintings(HttpExchange exchange, Gson gson, MyDatabase database) throws Exception {
        writeJson(exchange, gson.toJson(database.getPaintings()));
    }
